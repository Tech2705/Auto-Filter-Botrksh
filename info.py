...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002204000222 -1002714039167 -1002402051227').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002892668990') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002402051227') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://perpautofilter1:iloveufm@cluster0.zpybyhd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/A2ZSupportX')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/A2Zofficialupdates')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/WeRbackA2Z')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "1002892668990") #if is_stream = true then add a channel id ex: -10026393639
