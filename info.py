...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002204000222').split()]
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/+iLWA4LVhFFEyODNl')
...
UPI_ID = environ.get('UPI_ID', 'abhijeetgodiyal@oksbi') # Add your upi id here
# for stream
